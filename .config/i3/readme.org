...
# exec --no-startup-id feh --bg-scale ~/.dotfiles/.config/wallpaper/SynthwavePlanet.jpg
exec --no-startup-id wal -i .config/wallpaper/Mountain-Palm-Trees.jpg
exec --no-startup-id xfce4-power-manager
exec --no-startup-id pamac-tray
exec --no-startup-id clipit
exec --no-startup-id blueman-applet
exec --no-startup-id xautolock -time 10 -locker "betterlockscreen -l"
exec --no-startup-id ~/.config/polybar/lauch.sh
...
#+begin_src conf
# bar {
#     status_command /usr/share/bumblebee-status/bumblebee-status -m cpu memory playerctl battery datetime \
#     pasink -p time.format="%H:%M" -t iceberg-contrast #dracula-powerline #greyish-powerline
# #   position top
# }
