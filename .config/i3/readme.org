...
** bar
*** i3Blocks
I am using this minimalistic bar for its simple look
#+begin_src conf
bar {
...
#+begin_src conf
 ...
 # 		pasink -p time.format="%H:%M" -t  dracula-powerline #greyish-powerline
 # #        position top
 # }
...
This is in case I decide to use this again
#+begin_src conf
